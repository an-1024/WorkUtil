...
@Slf4j
public class QueryUserMainOfferPlatFormInIntfService {
    public static void main(String[] args) {
        ...
        OutputObject outputObj = JSON.parseObject(stringBuilder.toString(), OutputObject.class);

        Map<String, Object> objectMap = (Map<String, Object>) outputObj.getObject();
...
//				int resultRows = 0;
                    ...
                    for(Map<String, Object>  data : dataList ) {
                        ...
                        if(offerInfoMap.get("OFFER_TYPE") != null && StrUtil.equals("01", String.valueOf(offerInfoMap.get("OFFER_TYPE")))) {
                            ...
                            if(Long.parseLong(validDate)  - Long.parseLong(currentDate) < 0 && Long.parseLong(expireDate) - Long.parseLong(currentDate)> 0){
                                ...
                                /*调用CRM_UPC_OM_OI_QRY_005 商品信息查询查询主商品描述。wangshun*/
                                //定义商品描述为空
                                String curOfferDesc = "";
                                Map<String,Object>  intputMap= new HashMap<String, Object>();
                                intputMap.put("OFFER_ID", offerId);

                                infoMap.put("curOfferDesc",curOfferDesc);
                                ...
                                //infoMap.put("nextOfferName", offerInfoMap.get("offerName") == null ?"":String.valueOf(offerInfoMap.get("offerName")));
                                /*调用CRM_UPC_OM_OI_QRY_005 商品信息查询查询主商品描述。wangshun*/
                                //定义下周期商品描述为空
                                Map<String,Object>  intputMap= new HashMap<String, Object>();
                                intputMap.put("OFFER_ID", nextOfferId);
                
                                Map<String,Object> outPut= (Map<String, Object>) outputObj.getObject();
                                Map<String,Object> result= JSON.parseObject(outPut.get("result").toString(), new TypeReference<Map<String,Object>>(){});
                                //infoMap.put("nextOfferDesc", nextOfferDesc);
                            }
                            if("".equals(nextOfferDesc)) {
                                infoMap.put("nextOfferDesc", "");
                            }
                            else {
                                infoMap.put("nextOfferDesc", nextOfferDesc);
                            }

                            if("".equals(nextOfferId)) {
                                infoMap.put("nextOfferId", "");
                            }
                            else {
                                infoMap.put("nextOfferId", nextOfferId);
                            }

                            if("".equals(nextOfferName)) {
                                infoMap.put("nextOfferName", "");
                            }
                            else {
                                infoMap.put("nextOfferName", nextOfferName);
                            }
        ...
        outMap.put("LocalConstants.OUT_PARAMS.RESULT", infoList);
        log.info("查询用户主商品结果为：{}", JSON.toJSONString(outMap));
    }
}
